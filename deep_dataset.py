...
class AlignCollate(object):
    ...
    def __call__(self, batch):
        ...
        images, labels, real_label, img_path = zip(*batch)
...
#         print(len(image_tensors), len(labels), len(real_label))
        return image_tensors, labels, real_label, img_path
